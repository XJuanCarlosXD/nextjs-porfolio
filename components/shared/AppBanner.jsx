  ...
  return (
    ...
    >
      <div className="w-full md:w-1/3 text-left">
        ...
        >
          <a
            download="Curriculum Juan Carlos.pdf"
            href="/files/Curriculum Juan Carlos.pdf"
      ...
      >
        <Tilty perspective={3000}>
          <img
            layout="responsive"
            src={
              activeTheme === "dark" ? "/images/juan.jpg" : "/images/juan.jpg"
            }
            alt="Developer"
            className="w-96 h-96 rounded-lg text-right float-right shadow-lg"
          />
        </Tilty>
      </motion.div>
    </motion.section>
